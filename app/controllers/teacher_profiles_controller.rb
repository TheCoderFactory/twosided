class TeacherProfilesController < ApplicationController
  ...
  def connect_your_school
    @teacher_profile = current_user.teacher_profile
    @teacher_profile.update_attributes(school_id: params[:school])
  ...
  private
    ...
    def teacher_profile_params
      params.require(:teacher_profile).permit(:school_id, :user_id, :first_name, :last_name, :contact_phone, :profile_pic, :bio)
    end
end
