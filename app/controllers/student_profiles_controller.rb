class StudentProfilesController < ApplicationController
  ...
  private
    ...
    def student_profile_params
      params.require(:student_profile).permit(:first_name, :last_name, :address_line_1, :address_line_2, :suburb, :postcode, :state, :website_url, :contact_number, :degree, :institution, :working_with_children_number, :profile_pic, :induction, :bio)
    end
end
